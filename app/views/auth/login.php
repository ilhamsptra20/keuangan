<section class="vh-100">
    <div class="container-fluid h-custom">
        ...
        <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
            <form action="<?= BASEURL ?>authentication/login" method="POST">
            ...
            <div class="text-center text-lg-start mt-4 pt-2">
                ...
                <p class="small fw-bold mt-2 pt-1 mb-0">Apakah Anda Belum Memiliki Akun <a href="<?= BASEURL ?>register" class="link-danger">Register</a></p>
            </div>
